...
try:
    ...
    dbpedia_14_train, dbpedia_14_test = utils.load_and display_dataset_details()
    ...
    for model_name in models:
        if model_name == "albert":
            ...
            model_learner_ins = Model.create_and train_model(distilbert_train, distilbert_val, distilbert_transformer, model_name)
            ...
            print('##### Saving DistilBERT Model Fine-tuned on Dbpedia Dataset #####')
